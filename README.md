## Привет！ 👋
Начинающий QA-инженер с системным подходом. За 5 месяцев практики — полный цикл тестирования: от анализа требований до баг-репортов. Владею REST API (Postman, Swagger, Charles), SQL, создаю тест-документацию с нуля. Внимателен к деталям, быстро осваиваю инструменты, использую AI. Готов к офису (СПб) и удалёнке.
