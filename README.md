## Привет！ 👋
Начинающий QA-инженер с системным подходом. За 5 месяцев практики — полный цикл тестирования: от анализа требований до баг-репортов. Владею REST API (Postman, Swagger, Charles), SQL, создаю тест-документацию с нуля. Внимателен к деталям, быстро осваиваю инструменты, использую AI для рутинных задач. Готов к офису (СПб) и удалёнке.
...
## 🤝 Контакт
[![Email](https://img.shields.io/badge/Email-3b5998?style=flat-square&logo=Mail.Ru&logoColor=white)](mailto:karkardaniiil@yandex.ru)
[![Telegram Badge](https://img.shields.io/badge/-Telegram-0088cc?style=flat-square&logo=Telegram&logoColor=white)](https://t.me/DaniilKaramshev)
